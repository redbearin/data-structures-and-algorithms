...
const splitFoods = (recipe) => {
  ...
  for (let i=0; i<recipe.ingredients.length; i++) {
    let array = recipe.ingredients[i].split(' ');
    result.push(array.slice(2).join(' '));
  }
  return result;
};
...
For example:
  ...
  This works
  //https://gist.github.com/chad3814/2924672 read down to line 67

  This fails
    This works beautifully outside the function, but failed within the function.
    arr = [1,2,3,4,,6,7,8.9];
    arr = arr.filter(e => e % 2 === 1);
    console.log(arr;)

    no idea why failing within
